/**
 * authority — Content registry for the Vigilia™ Authority Hub.
 *
 * WHAT: Curated narrative content positioning Vigilia as the leading voice in human-centered relational systems.
...
export const AUTHORITY_SECTIONS: AuthoritySection[] = [
  // ── Week Stories ──────────────────────────────────────
  {
    ...
    featured: true,
    body: `Monday begins with a review. Father Miguel opens Vigilia and reads through the weekend's reflections — communion visitors noting quiet homes, lively conversations, a family asking about baptism preparation.
...
Saturday is quiet. Sunday, the visitors go out again. And the cycle renews — not because a dashboard demands it, but because presence has its own rhythm.`,
  },
  {
    ...
    description: 'How a digital equity team uses Vigilia to track device distribution, training sessions, and community engagement.',
...
Friday: Team reflection meeting. The shepherd reads the week's entries aloud. Everyone notices: the south side is growing. More families, more requests, more stories. A momentum signal, witnessed by humans.`,
  },
  {
    ...
    body: `Monday: The case coordinator opens Vigilia to review three families arriving this week. Each has a journey chapter already started — "Welcome & Orientation." Housing confirmations, airport pickup schedules, and cultural orientation dates are noted as reflections by the advance team.
...
Wednesday: A volunteer logs hours helping the Duong family navigate the bus system. The companion notices in Vigilia that Mrs. Duong mentioned wanting to cook Vietnamese food — she adds a Prōvīsiō request for a rice cooker.
...
Friday: Journey stage update. The Ahmadi family moves from "Welcome" to "Finding Footing." The companion writes: "They're beginning to ask questions about the future. That's how you know the settling has started."`,
  },
  {
    ...
    description: 'How an employment program uses Vigilia to track participant journeys without reducing people to placement metrics.',
...
Friday: Weekly narrative. The shepherd reads the week's reflections to the team. The mood is different from a metrics review. People are named. Stories are told. The work feels real.`,
  },
  {
    ...
    description: 'How a public library network uses Vigilia to deepen community connection beyond book circulation.',
    body: `Monday: The community engagement librarian opens Vigilia. Last week's Local Pulse flagged a neighborhood meeting about a proposed bus route change — one that would affect access to three branch libraries. She creates a reflection: "This route serves our most isolated patrons. We should be present at the next meeting."
...
Friday: Prōvīsiō requests reviewed. The teen room needs new headphones. The makerspace needs filament. The west branch needs bilingual signage. Each request tells a story about who's showing up and what they need.`,
  ...
  // ── Adoption Guidance ────────────────────────────────
  {
    ...
    archetype: 'workforce',
    roleFocus: 'leader',
    title: 'Adopting Vigilia in Workforce Development',
    description: 'Non-technical guidance for leaders bringing Vigilia into employment programs.',
...
Vigilia was designed for this reality. It doesn't ask for comprehensive data entry. It asks for noticing.
...
Next, customize your journey stages. The default labels may not fit. "Intake → Assessment → Training → Placement" is fine for reporting. But "Welcome → Understanding → Building Together → Stepping Forward" might be truer to your mission. Vigilia lets your language shape your system.
...
The rest — drift detection, signals, provisioning — comes naturally. The foundation is the reflection habit. Everything else grows from there.`,
  },
  {
    ...
    description: 'How leaders can model the adoption behaviors that make Vigilia come alive.',
    body: `1. Write the first reflection yourself. Don't ask your team to do something you haven't done. Open Vigilia, think about a conversation you had this week, and write one sentence. Your team will follow.
...
5. Trust the slow build. Vigilia doesn't deliver ROI in week one. It builds narrative depth over months. The organizations that thrive with Vigilia are the ones willing to let the story unfold at its own pace.`,
  },
  {
    ...
    archetype: 'nonprofit',
    roleFocus: 'steward',
    title: 'Your First Thirty Days with Vigilia',
    description: 'A gentle roadmap for the opening month — what to focus on, what to let emerge.',
    body: `Week one is about breathing. Don't try to import contacts. Don't customize every field. Just open Vigilia, write one reflection about someone you met with this week, and close it. That's enough.
...
Week three: look at your journey stages. Do the defaults match your language? If not, rename them. This is the moment Vigilia starts speaking your dialect. "Prospect" might become "New Friend." "Closed" might become "Walking Together." Use words your team would actually say aloud.
...
The rest of Vigilia — provisioning, drift detection, Local Pulse — all of it grows from this foundation. The reflections are the roots. Give them room.`,
  },
  {
    ...
    description: 'Why your team resists new systems — and how Vigilia earns trust differently.',
    featured: true,
...
Vigilia doesn't ask for compliance. It asks for noticing.
...
When introducing Vigilia to a team with CRM fatigue, don't start with a training session. Start with a question: "Who did you see this week?" Write their answer as a reflection. Show them what it looks like in the system. Then ask: "Does that feel different from what you were doing before?"
...
The technical features — journey stages, drift signals, provisioning — those come later. The first gift you give a tired team is the experience of being heard by the system instead of interrogated by it.`,
  ...
  // ── Narrative Essays ─────────────────────────────────
  {
    ...
    archetype: 'nonprofit',
    roleFocus: 'leader',
    title: 'Why Vigilia Is Not a CRM',
...
Vigilia inverts this. The relationship is the point. There is no transaction to optimize. There is no pipeline to close. There is only the ongoing, evolving, sometimes messy, always sacred reality of people in community.
...
When a Vigilia user opens their dashboard, they see reflections. Stories. Signals. Journey chapters. The visual grammar says: notice what's happening.
...
Vigilia was built for organizations that are tired of being measured and ready to be remembered.`,
  },
  {
...
This is narrative memory. And it's the foundation Vigilia is built on.
...
Vigilia treats silence differently. A quiet Compass means your relationships are in rhythm. No drift. No overdue follow-ups. No signals crying for attention. That's not a failure. That's faithfulness.
...
Vigilia was built for organizations that can sit with silence. That don't need constant validation from their tools. That understand: the absence of noise is the presence of faithfulness.
...
Vigilia uses the word "journey" deliberately. A journey doesn't have a conversion point. It has chapters. And chapters don't always move forward. Sometimes they loop. Sometimes they pause. Sometimes a person returns to an earlier chapter because life demanded it.

Consider Maria. She entered the program in "Welcome." She moved to "Building Together" over three months. Then her mother got sick, and she went silent for six weeks. In a pipeline, she'd be "lost." In Vigilia, she's in a chapter called "Holding Still."
...
Vigilia doesn't pretend to solve this tension. But it changes the evidence you bring to the table. Instead of "We served 847 people this quarter," you can say: "Let me read you three reflections from this month. Let me show you a journey chapter. Let me tell you about Maria."
...
The leaders who thrive with Vigilia are the ones willing to stand in front of a board and say: "I can't give you a number for what changed this quarter. But I can give you a story. And if you listen, you'll know."
...
In Vigilia, we call this person the Steward. Not "administrator." Not "office manager." Steward — because the role is sacred.
...
Vigilia gives stewards something most systems deny them: a narrative layer for operational work. When a steward processes a request for diapers, they can write: "Third request this month from the east corridor. Something is shifting in this neighborhood." That reflection sits alongside the companion's visit note and the shepherd's strategic review.

The steward's work is not separate from the mission. It is the infrastructure of presence. Vigilia was built to honor that.`,
  },
  {
    slug: 'when-to-let-go',
    category: 'leadership',
...
Vigilia doesn't make this decision for you. But it gives you the narrative context to make it wisely.
...
Vigilia honors the "not knowing." Unlike pipeline-driven systems that flag silence as failure, Vigilia simply holds the space. The journey chapter stays open. The reflections remain. And if the person returns — in a month, a year, a decade — the story is still there.

Letting go is not the same as forgetting. In Vigilia, you can release a relationship from active care without erasing the record of what you shared. That's a form of dignity most systems can't offer.`,
  },
...
Sister Theresa has been visiting the same seven families on this route for three years. She knows which dogs to watch for, which gates to open, which porches are safe to step on. Vigilia holds her reflections from every visit.
...
In the hollow below the ridge, cell service drops. Sister Theresa writes her reflections in a small notebook and enters them into Vigilia when she gets back to the parish office. The system doesn't mind the delay. It was built for people who do their work where signals don't reach.

Next week, she'll visit the same families. Some conversations will repeat. Some will surprise her. But she'll notice — because that's what companions do. And Vigilia will hold what she notices — because that's what the system was built for.`,
  },
  {
    ...
    description: 'How a regional food bank uses Vigilia to see beyond pounds distributed.',
    body: `The warehouse smells like cardboard and cold storage. Pallets arrive at 6 AM. By noon, the sorting team has processed 4,000 pounds of produce, dairy, and protein. The numbers go into the grant report. The stories go into Vigilia.
...
Vigilia answers these questions not through analytics but through accumulated reflections. Over six months, the director can read through the narrative layer and see things no spreadsheet reveals: the same families returning monthly, new faces from a neighborhood where a factory closed, volunteers who are themselves food-insecure.

The system doesn't editorialize. It doesn't flag trends with red badges. It simply holds what people noticed. And when the director needs to speak to the board about impact, she doesn't open a dashboard. She opens Vigilia and reads aloud.`,
  },
  {
...
The community health worker enters this reflection into Vigilia during a break. She doesn't log a "case interaction." She writes what she noticed. The system holds it alongside Mrs. Reyes' journey chapter — which shows three visits in the last two months, a move from "Hesitant" to "Trusting," and a Prōvīsiō request for medication assistance.

In clinical software, Mrs. Reyes is a patient ID and a diagnosis code. In Vigilia, she is a person who almost didn't come, who was afraid of being a bother, who needed someone to say: "That's exactly why I'm here."
