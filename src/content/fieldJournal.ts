...
export const FIELD_JOURNAL: FieldJournalEntry[] = [
  {
    ...
    body: [
      ...
      'When the parish adopted Vigilia, the steward assumed everyone would switch to the app. Margaret tried. She found the font too small, the screen too bright at night, and the idea of typing on glass while sitting with someone who just wanted company \u2014 uncomfortable.',
  ...
  },
  {
    ...
    body: [
      ...
      'Monday arrived. The director opened Vigilia and stared at an empty dashboard. No reflections. No visits logged. No signals. Just white space.',
      'This is normal.',
  ...
  },
  {
    ...
    body: [
      'Keisha opened Vigilia on a Monday morning expecting her usual signals \u2014 follow-up suggestions, visit reminders, maybe a drift notice. Instead, nothing. The dashboard was calm. No pending reflections to review. No unresponded signals.',
      ...
      'In most systems, quiet means neglect. In Vigilia, quiet can mean harmony. Keisha made herself a cup of tea and spent the morning reading through last week\'s reflections instead. She found stories she had missed \u2014 a participant who had gotten her GED, a volunteer who had connected two families.',
  ...
  },
  {
    ...
    body: [
      'The workforce development team had been using Vigilia for three weeks with the default journey stages: "First Encounter \u2192 Growing Trust \u2192 Active Partnership." But the language felt off.',
  ...
  },
  {
    ...
    body: [
      ...
      'David wrote a one-line reflection in Vigilia that evening: "Morales home dark. Ana quiet. Something different."',
