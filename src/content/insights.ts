...
export const insights: Insight[] = [
  {
    ...
    body: [
      ...
      'Vigilia was built for a different reality. Instead of pipelines, it offers journey chapters. Instead of lead scores, it offers reflections. Instead of conversion metrics, it offers narrative intelligence - the quiet awareness that emerges when you pay attention to people over time.',
  ...
  },
  {
    ...
    body: [
      ...
      'Vigilia builds relationship memory through reflections - private notes that capture what matters in a conversation, a visit, or a moment. Over time, these reflections create a living record that belongs to the organization, not just the individual.',
  ...
  },
  {
    ...
    body: [
      ...
      'Vigilia builds community awareness through Signum, its signal intelligence layer. Signum monitors local news, community events, and trusted sources, then surfaces relevant changes alongside your team reflections and relationship data.',
    ...
    closing: 'Awareness begins with noticing. Vigilia helps you notice.',
  },
  {
    ...
    body: [
      ...
      'Vigilia Visitor mode strips away everything that does not serve presence. No typing required. No forms. Just a microphone and a moment of reflection.',
  ...
  },
  {
    ...
    description: 'Leaders of mission-driven organizations need calm awareness, not urgent dashboards. Here is how Vigilia serves the Shepherd role.',
    ...
    body: [
      ...
      'Vigilia gives Shepherds a narrative overview - not a dashboard. The Metro Narrative reads like a letter from a thoughtful colleague. Drift Detection surfaces patterns, not emergencies. Journey chapters show arcs, not data points.',
      'The goal is not to make leaders faster. It is to make them wiser.',
    ],
    closing: 'Wisdom requires space. Vigilia creates it.',
  },
];
