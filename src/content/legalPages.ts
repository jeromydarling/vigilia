/**
 * legalPages — Content registry for Vigilia™ legal foundation pages.
 *
...
export const TERMS_CONTENT: LegalPageContent = {
  ...
  intro: 'Vigilia exists to help organizations care for people with clarity, memory, and dignity. These terms explain how we work together.',
  sections: [
    { id: 'using-cros', title: 'Using Vigilia', body: 'Vigilia™ is a relationship operating system designed for mission-driven organizations. By creating an account, you agree to use it in service of your community — with care, honesty, and respect for the people whose stories pass through it.' },
    { id: 'your-data', title: 'Your Data Belongs To You', body: 'All data you enter into Vigilia — reflections, contacts, journey notes, visit records — belongs to your organization. We are custodians, not owners. You may export your data at any time. If you leave Vigilia, your data leaves with you.' },
    { id: 'accounts', title: 'Accounts & Roles', body: 'Each organization receives its own isolated tenant. User roles — Steward, Shepherd, Companion, Visitor — determine what each person can see and do. Role assignments are managed by your organization\'s administrators, not by Vigilia.' },
    { id: 'communications', title: 'Communications & Email Intake', body: 'If you connect email, Vigilia processes incoming messages to surface relationship insights. Email content is never shared across organizations. Processing is opt-in, and you can disconnect at any time. We do not read, store, or sell email content for advertising.' },
    { id: 'ai', title: 'AI Assistance', body: 'Vigilia uses AI to organize reflections, suggest follow-ups, and surface narrative patterns. AI never makes decisions for your organization. Humans remain responsible for every relationship, every visit, every choice. AI assists the story — it never writes it.' },
    { id: 'availability', title: 'Availability', body: 'We work to keep Vigilia available and reliable. Scheduled maintenance will be communicated in advance. We do not guarantee 100% uptime, but we commit to transparency about any disruptions.' },
...
export const PRIVACY_CONTENT: LegalPageContent = {
  ...
  route: '/legal/privacy',
  lastUpdated: '2026-02-01',
  intro: 'Vigilia was built to help organizations remember people — not to harvest them.',
  sections: [
    ...
    { id: 'email-intake', title: 'Email Intake Processing', body: 'When email integration is enabled, Vigilia processes incoming emails to identify relationship-relevant content. Processing respects sender patterns and domain filters. Email content is scoped to the individual user and never visible to other team members unless explicitly shared.' },
    { id: 'cookies', title: 'Cookies & Minimal Analytics', body: 'Vigilia uses essential cookies for authentication only. We do not use tracking pixels, advertising cookies, or third-party analytics that follow you across the web. If we measure feature usage, it is aggregate and anonymous.' },
    ...
    { id: 'familia', title: 'Familia & Organizational Kinship', body: 'Vigilia may suggest organizational relationships using anonymized proximity and mission signals. These suggestions are based on geographic closeness, archetype similarity, and enrichment keyword overlap. You control whether you join or reveal your presence. No tenant names are disclosed without mutual public consent. All suggestions are optional and reversible.' },
    { id: 'children', title: 'Children & Sensitive Data', body: 'Vigilia is designed for organizational use by adults. We do not knowingly collect data from children under 16. If your organization serves minors, you are responsible for ensuring that any data entered complies with applicable child protection laws.' },
    { id: 'changes', title: 'Changes', body: 'We will notify account administrators of material privacy changes at least 30 days before they take effect. Your continued use of Vigilia after changes constitutes acceptance.' },
  ],
};
...
export const DPA_CONTENT: LegalPageContent = {
  ...
  lastUpdated: '2026-02-01',
  intro: 'This addendum clarifies how data flows between your organization and Vigilia — who controls what, and what protections are in place.',
  sections: [
    { id: 'ownership', title: 'Data Ownership', body: 'Your organization (the "Controller") owns all data entered into Vigilia. Vigilia (the "Processor") processes this data solely on your behalf, according to your instructions, and for the purposes you define. We do not process your data for our own purposes beyond providing the service.' },
    { id: 'scope', title: 'Processing Scope', body: 'Vigilia processes relationship data (contacts, reflections, visits, journey records), communication data (email intake when enabled), and organizational configuration (journey stages, roles, metro assignments). Processing activities include storage, retrieval, narrative intelligence generation, and signal aggregation.' },
...
export const ACCEPTABLE_USE_CONTENT: LegalPageContent = {
  ...
  lastUpdated: '2026-02-01',
  intro: 'Vigilia is built to support care, not control.',
  sections: [
    { id: 'respectful', title: 'Respectful Use', body: 'Use Vigilia to strengthen relationships, support communities, and honor the dignity of the people your organization serves. The platform is designed for mission-driven work — treat it, and the people within it, accordingly.' },
    { id: 'no-harassment', title: 'No Harassment or Exploitation', body: 'Vigilia must never be used to harass, stalk, intimidate, or exploit any person. This includes using relationship data to pressure, manipulate, or coerce individuals. If we become aware of such use, we will terminate access immediately.' },
    { id: 'lawful', title: 'Lawful Data Practices', body: 'You are responsible for ensuring that all data entered into Vigilia is collected lawfully and with appropriate consent. This is especially important when working with vulnerable populations, minors, or communities with heightened privacy needs.' },
    { id: 'protection', title: 'Protection of Vulnerable Communities', body: 'Many Vigilia organizations serve people in fragile circumstances — refugees, people experiencing homelessness, families in crisis. Extra care must be taken with their data. Never share identifying information outside your organization without explicit consent. Vigilia enforces tenant isolation to support this, but organizational responsibility is paramount.' },
  ],
};
