/**
 * lexicon — The Vigilia Lexicon™ content registry.
 *
 * WHAT: Curated definitions of key terms that form the Vigilia worldview.
 * WHERE: Rendered on /lexicon and /lexicon/:slug pages.
 * WHY: Establishes Vigilia as the authoritative language source for relational mission work.
 */
...
export const Vigilia_LEXICON: LexiconEntry[] = [
  // ── Concepts ──
  {
    ...
    body: `Narrative Relational Intelligence is the core philosophy behind Vigilia. It asserts that the deepest understanding of a relationship comes not from data points — open rates, click-throughs, or pipeline stages — but from the stories people tell about each other.
...
NRI is the bridge between technology and tenderness. It is the reason Vigilia exists.`,
  ...
  },
  {
    ...
    title: 'A Liturgy of Attention (Vigilia™)',
    category: 'Concept',
    summary: 'A living system that helps organizations care for communities without losing their humanity.',
    body: `Vigilia is not a CRM. It is a A Liturgy of Attention — a platform designed for organizations whose primary work is relational.

For the last forty years, technology has been driven by operating systems and artificial intelligence. Both were invented by humans, but both have largely remained cold, data-driven, and impersonal. Vigilia replaces the operating system paradigm with a human touch.

The word "Vigilia" represents a crossing — a relationship bridge between an organization and the community it serves. It combines Relationship Memory, Community Awareness, and Narrative Intelligence into a single living system.
...
Where most platforms track transactions, Vigilia remembers people. Where traditional AI analyzes data, NRI learns from human experience.`,
  ...
  },
  {
    ...
    category: 'Concept',
    summary: 'A pattern of mission work that shapes how an organization uses Vigilia.',
    body: `During onboarding, every Vigilia organization selects a Mission Archetype — a pattern that describes how they serve their community. Archetypes include Church / Faith Community, Digital Inclusion Nonprofit, Social Enterprise, Workforce Development, Refugee Support, Education Access, and Library System.

Each archetype adjusts the language, default journey stages, discovery keyword sets, and the narrative tone of NRI suggestions throughout the platform. A refugee support organization experiences Vigilia differently than a parish — not because the technology changes, but because the language adapts to honor the mission.
...
In Vigilia, the Shepherd role unlocks features designed for long-arc awareness: journey chapters, drift detection, and narrative reflections. The system supports the shepherd's memory so they can stay present with people rather than buried in data entry.`,
...
In Vigilia, the Companion role emphasizes activity logging, volunteer coordination, and provisioning — the practical tools that support consistent, caring presence without bureaucratic overhead.`,
...
In Vigilia, the Visitor role centers on visit tracking, presence signals, and the Impulsus journal — capturing the quiet moments that rarely make it into formal reports but always matter to the people involved.`,
...
In Vigilia, Stewards access Prōvīsiō for technology requests, Relatio for integration management, and Signum for discovery intelligence. They are the bridge between organizational needs and platform capability.`,
...
Presence signals are the heartbeat of NRI. They do not measure success. They witness movement.`,
  ...
  },
  {
    ...
    body: `Drift Detection is Vigilia's way of noticing when something has gone quiet. It does not trigger alarms or create urgency. It simply surfaces the observation: "You haven't recorded a visit with the Rodriguez family in six weeks."
...
Drift detection operates across journeys, visits, and reflection patterns. It is available in Vigilia Insight and higher tiers.`,
...
Momentum is not a target. It is a tide to be noticed and honored.`,
  ...
  // ── Practices ──
  {
    ...
    body: `Reflections are the sacred currency of Vigilia. They are brief written notes — not CRM activity logs, not task updates — but genuine moments of human noticing. "She seemed hopeful today." "He asked about the job fair for the first time." "The family brought cookies to the office."
...
Over time, reflections become the raw material of NRI — the narrative layer that turns data into story, and story into wisdom.`,
  ...
  },
  {
    ...
    body: `Journey Chapters replace the traditional CRM pipeline. Instead of "Lead → Qualified → Won/Lost," Vigilia uses stages that honor the human story: "First Encounter," "Growing Trust," "Active Partnership," "Quiet Season," "Renewed Connection."
...
Journey chapters are not linear. People move backward, sideways, and in circles. Vigilia honors that complexity rather than forcing it into a funnel.`,
  ...
  // ── Modules ──
  {
    ...
    body: `Testimonium is Vigilia's narrative telemetry system — a way of witnessing the stories that emerge from relationship work without reducing them to analytics. It aggregates patterns across reflections, visits, events, and journey movements to generate narrative summaries.
...
Testimonium serves both the organization and the public ecosystem. Anonymized, aggregated signals from Testimonium feed the public Signals page and Living Archetype stories.`,
  ...
  },
  {
    ...
    body: `Impulsus is the private journal layer of Vigilia — a space where individuals can capture moments of impact that don't fit into formal reporting. A photo from a community meal. A voice note after a difficult home visit. A sketch of an idea for next month's outreach.
...
Impulsus is available in Vigilia Story tier and above.`,
  ...
  },
  {
    ...
    body: `Civitas is the community awareness layer of Vigilia. It encompasses metro tracking, Local Pulse event discovery, and the Metro Narrative engine. Civitas helps organizations understand not just their own relationships but the broader community context in which those relationships exist.
...
Civitas data is never used for targeting or marketing. It exists to build awareness — the kind of knowing that makes presence meaningful.`,
  ...
  },
  {
    ...
    body: `Signum is the discovery intelligence layer of Vigilia. It helps organizations find new connections — potential partners, community events, grant opportunities, and volunteer prospects — through signal-based awareness rather than aggressive prospecting.
...
Discovery in Vigilia is always relational. Signum ensures that new connections begin with context, not cold contact.`,
  ...
  },
  {
    ...
    body: `Prōvīsiō is the internal technology request system within Vigilia. When an organization needs a new device deployed, a software license provisioned, or a technical resource allocated, Prōvīsiō manages the request lifecycle.
...
Prōvīsiō ensures that technology serves people — not the other way around.`,
  ...
  },
  {
    ...
    body: `Voluntārium is Vigilia's volunteer management layer — designed not for shift scheduling but for presence coordination. It tracks who showed up, what they noticed, and how their service connects to the broader relational story.

Volunteers in Vigilia are first-class citizens, not afterthoughts. Their reflections, visit notes, and event participation contribute to the organization's NRI just as meaningfully as staff entries.
...
Voluntārium includes hours logging, skill matching, and community story contribution — all in service of making volunteer presence visible and valued.`,
  ...
  },
  {
    ...
    body: `Relatio is the integration layer of Vigilia — the bridge between existing systems and the narrative-first world of Vigilia. It handles CRM migrations, email campaign connections, and data synchronization with external tools.
...
Relatio is available in the Vigilia Bridge tier.`,
...
export function getRelatedLexiconEntries(slug: string, max = 4): LexiconEntry[] {
  ...
  return entry.related
    .map((r) => Vigilia_LEXICON.find((e) => e.slug === r))
    .filter(Boolean)
