// STUB — Legacy CROS, removed for Vigilia
export function useCreateCampaignFromImport() { return { mutate: () => {} }; }
export type ImportedContactForCampaign = any;
...
export function useProvisionMode() { return { enabled: false, data: null }; }
export function useProvisions() { return { data: [] }; }
export function useOpportunityOrders() { return { data: [] }; }
export function useStoryMomentum() { return { data: null }; }
export function useGmailCampaignSend() { return { mutate: () => {}, isPending: false }; }
export default {};
export function useGmailConnectionStatus() { return { data: null, isLoading: false }; }
