/**
 * Calm Mode — Global UX system for Vigilia operator experience.
 *
 ...
 * WHY: Vigilia believes systems should serve humans gently, not alarm them.
 *
 * Governed by: src/lib/toneCharter.ts (Vigilia™ Tone & Language Charter)
 */
