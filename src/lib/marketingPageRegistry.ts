...
const ARCHETYPE_WEEK_PAGES: MarketingPageEntry[] = [
  { label: 'Church Week', path: '/archetypes/church-week', description: 'A 7-day story: what a week inside Vigilia looks like for a church. Mon–Sun narrative with voice notes, visits, and Sunday rhythm.' },
  { label: 'Nonprofit Week', path: '/archetypes/nonprofit-week', description: 'A 7-day story: digital inclusion nonprofit using Vigilia. Visits, voice notes, partner engagement, board narrative.' },
  ...
  { label: 'Ministry Outreach Week', path: '/archetypes/ministry-outreach-week', description: 'A 7-day story: parish or ministry team using Vigilia for pastoral care, home visits, and small groups.' },
];
  ...
  return [
    {
      ...
      purpose: 'Establishes Vigilia™ as a distinct category — not another CRM. These pages define the brand story, mission positioning, and trust signals that every other page links back to. All pages are static, hand-curated editorial content.',
      icon: 'Globe',
      status: 'complete',
      pages: [
        { label: 'Homepage', path: '/', description: 'Primary landing page with manifesto hero, archetype signals, and conversion pathways.' },
        { label: 'Manifesto', path: '/manifesto', description: 'The founding narrative — why Vigilia exists. Long-form editorial positioning that establishes brand philosophy and voice.' },
        { label: 'Vigilia™ Feature', path: '/cros', description: 'What Vigilia is — the relationship operating system overview. Explains Civitas, NRI, and the Latin module structure.' },
        { label: 'NRI™ (Neary)', path: '/nri', description: 'Narrative Relational Intelligence explained — how Vigilia uses human-first signals instead of traditional AI analytics.' },
        { label: 'Profunda™ Origin', path: '/profunda', description: 'The founding story — how Profunda became Vigilia. Builds emotional trust and shows authentic evolution.' },
    ...
    },
    {
      ...
      description: 'Dedicated pages for each Latin-named Vigilia module.',
      ...
      status: 'complete',
      pages: [
        { label: 'Features Overview', path: '/features', description: 'Unified feature map connecting all Vigilia modules. Entry point for visitors exploring the full platform.' },
        { label: 'Signum', path: '/signum', description: 'Discovery & signal intelligence — how Vigilia surfaces community events, partner movements, and local pulse without manual searching.' },
    ...
    },
    {
      ...
      purpose: 'Visitors arrive with different identities: pastor, field worker, executive director, volunteer coordinator. These pages help them recognize themselves in the system before signing up. The "Week Inside Vigilia" stories show realistic daily rhythms rather than feature lists.',
      icon: 'Users',
      status: 'complete',
      pages: [
        { label: 'Roles Index', path: '/roles', description: 'Overview of all Vigilia roles — Shepherd, Companion, Visitor, Steward. Entry point for identity-based discovery.' },
    ...
    },
    {
      ...
      status: 'complete',
      pages: [
        { label: 'Compare Index', path: '/compare', description: 'Vigilia vs traditional CRMs overview — positions Vigilia as a relationship system, not a sales pipeline.' },
        { label: 'Compare Archetype', path: '/compare/:slug', description: 'Archetype-specific comparisons — "Church using Vigilia vs Church using a donor CRM." Tailored to each mission context.' },
        { label: 'Vigilia vs Bloomerang', path: '/compare/cros-vs-bloomerang', description: 'Donor CRM vs Relationship Operating System — architectural comparison for nonprofits choosing between fundraising infrastructure and relational continuity.' },
        { label: 'Vigilia vs Salesforce', path: '/compare/cros-vs-salesforce', description: 'Enterprise CRM vs Relational OS — when to use Salesforce for scale and Vigilia for presence.' },
        { label: 'Vigilia vs HubSpot', path: '/compare/cros-vs-hubspot', description: 'Marketing CRM vs Relational OS — campaign automation compared to relationship memory.' },
        { label: 'Vigilia Mission Layer', path: '/compare/cros-mission-layer-crm', description: 'The relational intelligence layer above your existing CRM — works with Salesforce, Bloomerang, HubSpot, and more.' },
        ...
        { label: 'Relational Fundraising', path: '/fundraising-without-a-donor-crm', description: 'SEO article targeting "fundraising without a donor CRM" — long-form narrative positioning Vigilia for orgs avoiding donor management systems.' },
        ...
        { label: 'Imagine This', path: '/imagine-this', description: 'Scenario-based storytelling — three mission contexts (social work, nonprofit leadership, ministry) showing daily life with Vigilia.' },
      ],
    },
    {
      id: 'p5',
      ...
      purpose: 'Vigilia defines its own vocabulary — "relationship memory," "narrative intelligence," "communal stewardship." These pages establish Vigilia as the canonical source for this civic ontology, generating schema.org DefinedTerm markup that search engines treat as authoritative definitions.',
      icon: 'BookOpen',
      status: 'complete',
      pages: [
        { label: 'Lexicon Index', path: '/lexicon', description: 'All defined terms in the Vigilia vocabulary — each generates a schema.org DefinedTerm with cross-links to related concepts.' },
        ...
        { label: 'Library Concept', path: '/library/:conceptSlug', description: 'Deep concept pages — each explores a Vigilia principle with narrative depth, related terms, and cross-links.' },
      ],
    },
    {
      id: 'p6',
      ...
      pages: [
        ...
        { label: 'Stories', path: '/stories/:slug', description: 'Standalone narrative stories — community vignettes that illustrate Vigilia principles in practice.' },
        { label: 'Authority Hub', path: '/authority', description: 'Trust & authority signals hub — aggregates all content that establishes Vigilia as a credible voice in community technology.' },
    ...
    },
    {
      ...
      purpose: 'Creates geographic SEO authority — Vigilia becomes the canonical source for "how churches serve in urban metros" or "nonprofit community work in midsize cities." Uses schema.org/Place and curated narrative content. Metro pages can surface anonymized living signals when aggregation thresholds are met.',
      icon: 'Map',
      status: 'complete',
      pages: [
    ...
    },
    {
      ...
      status: 'complete',
      pages: [
        { label: 'Network Directory', path: '/network', description: 'Public communio directory — browsable index of organizations using Vigilia, filtered by archetype and metro.' },
        ...
        { label: 'Tenant Public Mirror', path: '/public/:tenantSlug', description: 'Optional public profile for Vigilia tenants — displays archetype, calling, metro, and narrative themes. Opt-in only.' },
        { label: 'Public Presence Page', path: '/p/:tenantSlug', description: 'Lightweight public presence — standalone page for organizations to share their Vigilia identity externally.' },
        ...
        { label: 'Week Narrative (Generic)', path: '/week/:slug', description: 'Reusable week narrative template — shows "a week inside Vigilia" for any archetype using a shared layout.' },
      ],
    },
    {
      id: 'p10',
      ...
      purpose: 'Required trust infrastructure — these pages satisfy legal requirements while reinforcing Vigilia values. The AI Transparency page is particularly important for positioning NRI as human-first intelligence.',
      icon: 'FileText',
      status: 'complete',
      pages: [
        { label: 'Terms of Service', path: '/legal/terms', description: 'Platform terms of service — plain-language legal framework for Vigilia usage.' },
        ...
        { label: 'Acceptable Use', path: '/legal/acceptable-use', description: 'Acceptable use policy — boundaries for platform usage aligned with Vigilia values of dignity and privacy.' },
        { label: 'AI Transparency', path: '/legal/ai-transparency', description: 'How NRI uses AI — transparency about what AI does and doesn\'t do in Vigilia, reinforcing human-first principles.' },
      ],
    },
    {
      id: 'p11',
